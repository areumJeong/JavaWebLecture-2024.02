...
public class KcityController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "list":
			...
			rd = request.getRequestDispatcher("/ch07/kcity/list2.jsp");
		...
		case "insert":
			if (method.equals("GET")) {
				rd=request.getRequestDispatcher("/ch07/kcity/insert2.jsp");
				rd.forward(request, response);
			} else {
		...
		case "update":
			if (method.equals("GET")) {
				...
				rd = request.getRequestDispatcher("/ch07/kcity/update2.jsp");
		...
		default:
			rd = request.getRequestDispatcher("/ch07/kcity/alertMsg2.jsp");
